...
import categoryData from "../pages/products/data/categoryData"; // Adjust path if needed
    ...
    <div>
      <div className="bg-white border-t border-b border-gray-200 hidden lg:block">
        <div className="flex justify-between items-center w-11/12 md:w-10/12 mx-auto py-2">
          ...
          {/* Contact Button */}
          <div className="btn bg-[#ff0000] border-none text-white px-4 py-5 rounded-md hover:bg-black transition duration-300 cursor-pointer">
